...
const DTable = () => {
    ...
    const columns = [
        { name: "Nb", selector: (row) => row.details.length, sortable: true },
        { name: "Nom", selector: (row) => row.name, sortable: true },
        { name: "Total", selector: (row) => row.total, sortable: true },
        { name: "Commerce", selector: (row) => "Carrefour", sortable: true },
        ...
        { name: "Pourcent", selector: (row) => "45%", sortable: true },
    ...
    return (
        <DataTable
            ...
            customStyles={{
                ...
                pagination: {
                    style: {
                        backgroundColor: "#111827", // Couleur de fond de la pagination
