const Weather = () => {
    return (
        <>
            <div className="max-w-md px-5 py-4 mx-auto rounded-lg dark:bg-gray-700 dark:text-white">
                <div className="flex justify-between space-x-7">
                    <div className="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                             className="w-15 h-15 p-2 dark:text-yellow-600 fill-white">
                            <path
                                d="M256,104c-83.813,0-152,68.187-152,152s68.187,152,152,152,152-68.187,152-152S339.813,104,256,104Zm0,272A120,120,0,1,1,376,256,120.136,120.136,0,0,1,256,376Z"></path>
                        ...
                        <h1 className="text-xl font-semibold">Charleroi</h1>
                    </div>
                    <span className="font-bold text-5xl pt-8">14°</span>
                </div>
                <div className="flex justify-between mt-8 space-x-4 dark:text-gray-600">
                    <div className="flex flex-col text-white items-center space-y-1">
                        <span className="uppercase text-xs">Lun</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-white">
                            ...
                            <polygon
                                points="126.029 496 159.817 496 223.153 309.136 192.847 298.864 126.029 496"></polygon>
                            <polygon
                                points="294.029 496 327.817 496 391.153 309.136 360.847 298.864 294.029 496"></polygon>
                            <polygon
                                points="290.11 251.033 225.781 448 259.445 448 320.529 260.967 290.11 251.033"></polygon>
                            <polygon
                                points="128.791 251.033 64.461 448 98.125 448 159.209 260.967 128.791 251.033"></polygon>
                        </svg>
                        <span>11°</span>
                    </div>
                    <div className="text-white flex  flex-col items-center space-y-1">
                        <span className="uppercase text-xs">Mar</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w5 h-5 fill-white">
                            <path
                    ...
                    <div className="flex flex-col text-white items-center space-y-1">
                        <span className="uppercase text-xs">Mer</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-white">
                            <path
                    ...
                    <div className="flex flex-col text-white items-center space-y-1">
                        <span className="uppercase text-xs">Jeu</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-white">
                            <polygon
                    ...
                    <div className="flex flex-col text-white items-center space-y-1">
                        <span className="uppercase text-xs">Ven</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-white">
                            <path
                                d="M382.76,432H136c-30.732,0-61.371-12.725-84.061-34.912-23.221-22.707-36.009-52.35-36.009-83.469A109.4,109.4,0,0,1,49.136,235.2a122.281,122.281,0,0,1,62.794-32.707V200c0-79.4,64.6-144,144-144s144,64.6,144,144v1.453c55.716,7.939,96,53.729,96,112.166,0,31.27-11.375,60.72-32.031,82.927A109.747,109.747,0,0,1,382.76,432ZM255.93,88a112.127,112.127,0,0,0-112,112v31.405l-14.864,1.059c-45.5,3.239-81.136,38.887-81.136,81.155C47.93,359.635,89.084,400,136,400H382.76c45.515,0,81.17-37.943,81.17-86.381,0-46.566-33.731-80.791-80.2-81.379l-15.8-.2V200A112.127,112.127,0,0,0,255.93,88Z"></path>
                        </svg>
