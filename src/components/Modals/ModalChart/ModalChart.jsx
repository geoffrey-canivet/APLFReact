...
const ModalChart = ({closeModal, categoryId}) => {
    ...
    useEffect(() => {
        ...
        `,
            ...
            didOpen: () => {
                ...
                ReactDOM.render(<ChartDonut categoryId={categoryId} />, document.getElementById("chart-container"));
            },
            willClose: () => {
                // Nettoyer le DOM pour éviter les fuites de mémoire
                ReactDOM.unmountComponentAtNode(document.getElementById("chart-container"));
            },
