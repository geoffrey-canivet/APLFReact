...
const ModalupdateIncome = ({handleUpdateIncome, incomeId, dataIncome, closeModal}) => {
    ...
    useEffect(() => {
            ...
            <form class="max-w-sm mx-auto">
					<div class="grid grid-cols-1 gap-2 max-w-md mx-auto mt-3">
						...
						<div class="relative">
							...
							<input type="text" id="inputPrix" class="bg-gray-50 mb-2 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Prix">
						</div>
                    </div>
				</form>
				<style>
        ...
        `,
            ...
            if (result.isConfirmed) {
                handleUpdateIncome(result.value)
                ToastNotification.fire({
                    icon: "success",
                    title: `${result.value.name} modifié avec succès.`,
                });
            }
            closeModal();
        });
    }, [ToastNotification, closeModal, handleUpdateIncome]);
