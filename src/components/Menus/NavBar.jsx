            ...
            <nav
                ...
                <div className="flex flex-wrap items-center justify-between mx-auto p-3 pl-10 pr-10">
                    ...
                    <div className="relative flex dark:text-white">
                        ...
                        {/* Dropdown menu */}
                        <div id="dropdownAvatar" className={`z-10 absolute right-0 mt-2 w-44 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-600 ${navDropdown ? "block" : "hidden"}`}>
