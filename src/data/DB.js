...
const cardData = [
    ...
    },
    {
        ...
        data: [
            ...
            { id:4, name: "MasterCard", price: "200" },
            { id:55, name: "American Express", price: "100" },
        ],
        total: null,
    },
    {
        ...
        icon: faUmbrella,
        data: [
            { id:77, name: "Maison", price: "150" },
            { id:87, name: "Voiture", price: "250" },
            { id:89, name: "Santé", price: "200" },
        ],
        total: null,
    },
    {
        ...
        icon: faTicket,
        data: [
            { id:98, name: "Netflix", price: "15" },
            { id:34, name: "Spotify", price: "10" },
            { id:18, name: "Amazon Prime", price: "12" },
        ],
        total: null,
    },
    {
