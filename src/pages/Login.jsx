        ...
        <>
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div className="w-full bg-white rounded-lg dark:border md:mt-0 shadow-md sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-800">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <div>
                                    <label htmlFor="password"
                                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Votre mot de passe</label>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="#"
                                       className="text-sm font-medium text-primary-600 hover:text-gray-300 dark:text-gray-500">Mot de passe oublié?</a>
                                </div>
                                <button type="button"
